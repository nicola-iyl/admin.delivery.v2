      ...
      <ul className="navbar-nav ms-auto ms-auto me-3 me-lg-4">
        <li className="nav-item dropdown">
          ...
          <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
            <li>
              <Link className="dropdown-item" to="/profile"><FontAwesomeIcon icon={ faInfoCircle } /> Profilo</Link>
            </li>
            <li>
              <hr className="dropdown-divider" />
            </li>
            <li>
              <button type="button" className="dropdown-item" onClick={(e) => logoutSubmit(e)}><FontAwesomeIcon icon={ faSignOutAlt } /> Logout</button>
            </li>
          </ul>
        </li>
      </ul>
